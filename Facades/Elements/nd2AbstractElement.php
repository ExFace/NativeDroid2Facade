...
use exface\NativeDroid2Facade\Facades\NativeDroid2Facade;
...
new $.nd2Toast({ // The 'new' keyword is important, otherwise you would overwrite the current toast instance
   ...
   ttl : {$this->getFacade()->getConfig()->getOption('GENERAL.TOAST_TIME_TO_LIVE_MS')} // optional, time-to-live in ms (default: 3000)
});
JS;
    }
}
